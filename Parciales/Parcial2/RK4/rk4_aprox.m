% Solución del pendulo doble con aproximación 
...
title('Pendulo doble con aprox \theta_1 ');grid on;

subplot(2,1,2);
plot(t, theta2, 'b-','Linewidth', 1.5);
xlabel('t'); ylabel('\theta_2');
title('Pendulo doble con aprox \theta_2');grid on;
print -djpeg -r100 RK4_aprox.jpeg


figure(2); clf;
plot(theta1, theta2, 'b-', 'Linewidth', 0.0000001);
xlabel('\theta_1');ylabel('\theta_2');title('Espacio de fase');grid on;
axis equal;
print -djpeg -r100 RK4_aprox_fase.jpeg