...
% Grafica de vx vs t
figure(3);clf;
plot(t, vx,'k-','lineWidth', 3);grid on;
...
% Grafica de vy vs t
figure(4);clf;
plot(t, vy,'k-','lineWidth', 3);grid on;
